...
int main() {
    ...
    while (play) {
        ...
        cout << "\n\n\t\t--------";
        cout << "\nWelcome to BINGO! The goal of this game is to guess a 5 words on a randomized BINGO board(Can be including a freespace) and see if those 5 words you chose made a bingo on the random board. ";
