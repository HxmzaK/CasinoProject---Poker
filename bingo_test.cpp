...
// This is a simple version of the program
// It could be refactored and optimised, but it works as it is
// The bots get a random chance to win, but there takes a long time to get the win (by a stroke of luck )
...
int main(){
    ...
    string result[5];
    int score = 0, scoreBot1=0, scoreBot2=0;
    bool play = 1;
    ...
    while (play) {
        cout << "\nCURRENT PLAYER SCORE: " << score << "\nCURRENT BOT 1 SCORE: " << scoreBot1 << "\nCURRENT BOT 2 SCORE: " << scoreBot2;
        cout << "\n\n\t\t--------";
        //cin >> choice;
        ...
        case 1: {
            ...
            case 3: {
                cout << "Thank you for playing! :)" << endl << "The final score is: " << score;
